...
POLICIES = {"project_documents": DOCUMENT_LIBRARY_TYPES, "document-library": DOCUMENT_LIBRARY_TYPES,
            ...
            "daily_reports": {key: value for key, value in DOCUMENT_LIBRARY_TYPES.items() if key in {"jpg", "jpeg", "png", "webp", "heic", "heif"}},
            "daily-reports": {key: value for key, value in DOCUMENT_LIBRARY_TYPES.items() if key in {"jpg", "jpeg", "png", "webp", "heic", "heif"}},
