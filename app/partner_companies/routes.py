...
from app.auth.permissions import can_access_partners_module, can_create_partner, can_edit_partner
...
def index():
    ...
    return render_template("partner_companies/index.html", companies=companies, industries=industries, filters=request.args, can_create=can_create_partner())
